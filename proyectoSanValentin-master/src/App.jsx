...
function App() {
  ...
  {
    id: 2,
    description: "Vamos, piensalo de nuevo.",
  ...
  {
    id: 10,
    description: "Piensalo por segunda vez",
    ...
    <main id="canvas" className="fondo w-screen h-screen bg-no-repeat bg-cover flex items-center justify-center bg-center ">
      {
        !valueSi ? (
          <div className="p-5">
            <h1 className="text-white font-bold text-5xl text-center">¿Quieres ser mi cita de San Valentin?</h1>
          ...
          <div className="flex justify-center items-center flex-col space-y-10">
            <h1 className="text-4xl text-white font-bold">Nunca dude que dijeras que sí ❤️!</h1>
